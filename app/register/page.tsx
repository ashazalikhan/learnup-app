...
export default function RegisterPage() {
  ...
  const handleEmailRegister = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setSuccessMsg("Check your college email and confirm the account, then log in.");
    }
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0 animate-enter">
            <div className="bg-surface rounded-2xl border-2 border-border p-8 space-y-6 shadow-[0_4px_0_var(--border)]">
              <div className="space-y-1">
                <h1 className="text-2xl font-extrabold text-text-primary tracking-tight">Create an account</h1>
                <p className="text-sm text-text-muted">
                  Email first. Progress lives on your account, not this PC.
                </p>
              </div>
              ...
              <form className="space-y-4" onSubmit={handleEmailRegister}>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="What should the class see?"
                ...
                {successMsg && <p className="text-xs text-accent-green font-medium">{successMsg}</p>}
              ...
              <div className="pt-4 text-center border-t-2 border-border">
                <p className="text-sm text-text-muted">
                  ...
                  <Link href="/login" className="text-accent-green hover:underline font-bold">
                    Log in
                  </Link>
                </p>
              </div>
