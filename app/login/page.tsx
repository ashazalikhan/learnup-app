          ...
          <div className="w-full max-w-md mx-auto lg:mx-0 animate-enter">
            <div className="bg-surface-secondary rounded-2xl border border-border p-8 space-y-6">
              ...
              <div className="space-y-2 text-center pb-2">
                ...
                <p className="text-sm text-text-muted">Log in to continue your journey</p>
              </div>
              ...
              <form className="space-y-4" onSubmit={handleEmailLogin}>
                ...
                <Button variant="default" size="lg" className="w-full" type="submit" disabled={isLoading === "email" || isLoading === "admin"}>
                  {(isLoading === "email" || isLoading === "admin") ? <span className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></span> : "Log in"}
                </Button>
              </form>
